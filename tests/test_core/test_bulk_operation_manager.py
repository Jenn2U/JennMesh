...
def db(tmp_path) -> MeshDatabase:
    ...
    db.upsert_device(
        "!b001", long_name="R1", role="ROUTER",
        hw_model="heltec_v3", firmware_version="2.5.6",
        mesh_status="reachable",
    )
    db.upsert_device(
        "!b002", long_name="R2", role="ROUTER",
        hw_model="heltec_v3", firmware_version="2.5.6",
        mesh_status="reachable",
    )
    db.upsert_device(
        "!b003", long_name="M1", role="CLIENT",
        hw_model="tbeam", firmware_version="2.4.2",
        mesh_status="unknown",
    )
    db.upsert_device(
        "!b004", long_name="S1", role="SENSOR",
        hw_model="rak4631", firmware_version="2.5.0",
    )
    return db
